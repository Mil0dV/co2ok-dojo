...
def readArraySite(url):
    print("http://r.srvtrck.com/v1/redirect?url=http%3A%2F%2F" + url \
    + "%2Fapi_key=6192753faa5975d8d9450690274e77dd&site_id=249c53bccf944c4c8f010cf6c914f30c&type=url&source=https%3A%2F%2Fco2ok.ninja")
    if(Network == "awin"):
        return "http://www.awin1.com/cread.php?awinmid=http%3A%2F%2F" + FindAwinMid(url) + "&awinaffid=533371&clickref=chex&p=http%3A%2F%2F" + url + "%2F"
    elif(Website == "bol"):
        return "https://partner.bol.com/click/click?p=2&t=url&s=51851&f=TXL&url=http%3A%2F%2F" + url + "%2F"
    elif(Website == "coolblue"):
        return "https://prf.hn/click/camref:" + FindCoolblue(url) + "/destination:http%3A%2F%2F" + url + "%2F"
    elif(Website == "ebay"):
